  ...
  return (
    <Layout>
      <Box>
        ...
        <Typography variant="h5">
          <u>Transparency</u>: Proof of Funds on the part of the client. In a
          Web2 world, even if the banks can attest to the funds owned by the
        ...
        <Typography variant="h5">
          ...
          providing incentive to see through the process till the end. This can
          be programmed straight into the Smart Contract itself.
        </Typography>
